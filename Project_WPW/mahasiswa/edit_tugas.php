...
$data = mysqli_query($conn, "SELECT * FROM unggah WHERE tugas='$id'");
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <form method="post" action="edit_uptugas.php" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="tugas" class="form-label">Deskripsi Tugas</label>
                        <input type="hidden" name="tugas" value="<?php echo $d["tugas"]; ?>">
                    </div>
                    <div class="mb-3">
